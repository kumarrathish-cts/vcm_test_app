...
export default class chartComponent extends Component {
    ...
    render() {
        ...
        return (
            !this.state.barChart ?
            <View>
                <GButtonComponent buttonText={"Bar Chart"} onPress={() =>this.setState({ barChart : !this.state.barChart })} buttonStyle={styles.buttonStyle}/>
            ...
            <View>
                ...
                <GButtonComponent buttonText={"Pie Chart"} onPress={() => this.setState({ barChart : !this.state.barChart})} buttonStyle={styles.buttonStyle}/>
                <BarChart
                style={ { height: 200 } }
                data={ barData }
