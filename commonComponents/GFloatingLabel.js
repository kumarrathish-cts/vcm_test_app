...
const createStyles = () => {
  return StyleSheet.create({
    ...
    input: {
        ...
        fontSize: convertToDeviceResolution(14),
        paddingLeft: convertToDeviceResolution(10),
        marginTop: convertToDeviceResolution(17),
        // marginBottom: convertToDeviceResolution(5)
    },
    label: labelStyleObj
  });
}
...
let cleanStyle = {
  fontSize: convertToDeviceResolution(20),
  top: convertToDeviceResolution(7)
};

let dirtyStyle = {
  fontSize: convertToDeviceResolution(12),
  top: convertToDeviceResolution(-17)
};

let takeBigFontUp = {
  top: convertToDeviceResolution(-22)
};
...
const labelStyleObj = {
  marginTop: convertToDeviceResolution(21),
  paddingLeft: convertToDeviceResolution(9),
  color: "#AAA",
  position: "absolute",
  fontSize: convertToDeviceResolution(14)
};
